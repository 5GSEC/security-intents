...
|FGT1195 & | Supply Chain Compromise | Adversaries may manipulate products or product delivery mechanisms prior to receipt by a final consumer for the purpose of data or system compromise.| Yes |

Supply chain compromise can take place at any stage of the supply chain including:| Yes |

Manipulation of development tools| Yes |
Manipulation of a development environment| Yes |
Manipulation of source code repositories (public or private)| Yes |
Manipulation of source code in open-source dependencies| Yes |
Manipulation of software update/distribution mechanisms| Yes |
Compromised/infected system images (multiple cases of removable media infected at the factory) (Citation: IBM Storwize) (Citation: Schneider Electric USB Malware)| Yes |
Replacement of legitimate software with modified versions| Yes |
Sales of modified/counterfeit products to legitimate distributors| Yes |
Shipment interdiction| Yes |
